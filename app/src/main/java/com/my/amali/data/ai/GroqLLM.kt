...
$appsSection
    ...
    private fun compactPrompt(options: EngineOptions): String {
        ...
        val state = buildString {
            ...
            // Как приложение слышит пользователя. Whisper не знает предметной
            // области и на слух пишет «вай фай» — модель должна понимать, что
            // распознанный текст может содержать такие огрехи, и не
            // переспрашивать из-за одного кривого слова.
            append("; слух whisper, текст может быть с ошибками распознавания")
        }
