...
internal object VoiceAudio {
     ...
     * когда-нибудь изменится, пороги тишины поедут вместе с ним. Тип Long
     * выбран осознанно: этой величиной измеряется время записи, и все
     * пороги тишины в проекте — тоже Long, чтобы не приводить типы в
     * горячем цикле чтения микрофона.
     */
    const val FRAME_MS: Long = (FRAME_SAMPLES * 1000L) / SAMPLE_RATE
